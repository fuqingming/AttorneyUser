package com.xinfu.attorneyuser.utils.imagetrans;
...
public class TileBitmapDrawable extends Drawable
{
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object>
    {
        ...
        protected Object doInBackground(Object... params)
        {
            ...
            final float minScale = Math.min(BaseApplication.getScreenWidth() / (float) decoder.getWidth(), BaseApplication.getScreenHeight() / (float) decoder.getHeight());
