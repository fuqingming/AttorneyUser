...
public class ImageLoader
{
    ...
    public void loadImg(Context context , ImageView imageView , String imgUrl,int pic)
    {
        load(context,imageView,imgUrl,context.getResources().getDrawable(pic),null,false,false,false,0);
    }
    ...
    public void loadCircleImg(Context context , ImageView imageView , File imgUrl)
    {
        load(context,imageView,imgUrl,null,null,true,false,false,0);
    }
    public void loadCircleImg(Context context , ImageView imageView , File imgUrl,int pic)
    {
        load(context,imageView,imgUrl,context.getResources().getDrawable(pic),null,true,false,false,0);
    }
    ...
    public void load(Context context , ImageView imageView , File file, Drawable defaultImage,
                     Drawable errorImage , boolean isCropCircle, boolean isRoundedCorners, boolean isGrayscale, int radius)
    {
        ...
        if (isCropCircle)
        {
            genericRequestBuilder =  Glide.with(context).load(file)
                    .bitmapTransform(new CropCircleTransformation(context));
        }
        //是否切成圆角
        if (isRoundedCorners)
