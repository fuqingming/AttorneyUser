...
public class PopupwindowIntegralRecharge extends PopupWindow
{
    public PopupwindowIntegralRecharge(final Activity context, final OnTaskSuccessComplete onTaskSuccessComplete,String strScore)
    {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View m_pwMenuView = inflater.inflate(R.layout.ppw_integral_recharge_service, null);
        ...
        m_tvCommit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                else if(Integer.parseInt(strAcount) > Integer.parseInt(strScore))
                {
                    Utils.showToast(context, "您有积分"+strScore+"，超过兑换额度");
                    m_etCount.requestFocus();
                    return;
                }
                dismiss();
