...
public class ContractTypeAdapter extends MBaseAdapter<ContractTypeBean> {

	public ContractTypeAdapter(Activity context, List<ContractTypeBean> datas, int normalBg, int pressBg) {
		super(context, datas);
	}
	
	@Override
	public View getView(final int position, View convertView, ViewGroup parent) {
		ContractTypeBean jobType = (ContractTypeBean) getItem(position);
	        final View view;
	        ViewHolder holder;
	        if(convertView == null) {
	        ...
	        holder.tv.setText(jobType.getTitle());
