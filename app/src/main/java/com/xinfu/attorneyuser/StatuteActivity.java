...
public class StatuteActivity extends BaseListActivity{
    ...
    {
        Utils.initCommonTitle(this,"法律法规",true);
    }
    ...
    protected void initLayoutManager() {
        ...
        header.findViewById(R.id.tv_search).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Utils.showToast(StatuteActivity.this,"请输入要搜索的内容！");
                    m_etSearch.requestFocus();
                    return;
                }
                intentWebView("http://search.chinalaw.gov.cn/SearchLawTitle?effectLevel=&SiteID=124&Query="+ strSearch +"&Type=1");
            }
        });
    }
    ...
    {
        Intent it = new Intent(StatuteActivity.this,WebViewActivity.class);
    ...
    protected void requestData() {
        ApiStores.helpListTag("regulation", new HttpCallback<ResponseBaseBean>()
        {
            @Override
            public void OnSuccess(final ResponseBaseBean response)
            {
                ...
                else
                {
                    ...
                    setEventBus();
                    FailureDataUtils.showServerReturnErrorMessageFragment(StatuteActivity.this,response, Const.ForResultData.LOGIN_ACTIVITY_GET_DATA);
                }
