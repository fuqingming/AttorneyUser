...
public class EnterpriseMsgActivity extends BaseListActivity{
    ...
    {
        Utils.initCommonTitle(this,"企业信息",true);
    }
    ...
    protected void initLayoutManager() {
        ...
        header.findViewById(R.id.tv_search).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Utils.showToast(EnterpriseMsgActivity.this,"请输入要搜索的内容！");
    ...
    {
        Intent it = new Intent(EnterpriseMsgActivity.this,WebViewActivity.class);
    ...
    protected void requestData() {
        ApiStores.helpListTag("company", new HttpCallback<ResponseBaseBean>()
        {
            @Override
            public void OnSuccess(final ResponseBaseBean response)
            {
                ...
                else
                {
                    ...
                    setEventBus();
                    FailureDataUtils.showServerReturnErrorMessageFragment(EnterpriseMsgActivity.this,response, Const.ForResultData.LOGIN_ACTIVITY_GET_DATA);
                }
