...
public class FragmentGroupListed extends BaseFragment {
    ...
    {
        return R.layout.fragment_group_listed;
    }

    private void getData()
    {
        ApiStores.userAddService("market",m_iType, m_strName,m_strPhone,m_strContent,m_strCompany,new HttpCallback<ResponseBaseBean>()
        {
            @Override
    ...
    @OnClick({R.id.btn_ok,R.id.text1,R.id.text2})
