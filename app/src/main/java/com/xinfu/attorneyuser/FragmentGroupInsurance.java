...
public class FragmentGroupInsurance extends BaseFragment {

    @BindView(R.id.name_edt)
    EditText m_etName;
    @BindView(R.id.phone_edt)
    EditText m_etTel;
    @BindView(R.id.et_court_msg)
    EditText m_etCourtMsg;
    ...
    private String m_strCourtMsg;
    private String m_strAmount;

    @Override
    protected int setLayoutResourceId()
    {
        return R.layout.fragment_group_insurance;
    }

    private void getData()
    {
        ApiStores.userAddService("insurance",m_iType, m_strName,m_strPhone,m_strContent,"",new HttpCallback<ResponseBaseBean>()
        {
            @Override
    ...
    private boolean isInputValid()
    {
        ...
        m_strCourtMsg = m_etCourtMsg.getText().toString().trim();
