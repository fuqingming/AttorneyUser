package com.xinfu.attorneyuser.huanxin;
...
import com.xinfu.attorneyuser.MainActivity;
import com.xinfu.attorneyuser.R;
import com.xinfu.attorneyuser.huanxin.conference.ConferenceActivity;
import com.xinfu.attorneyuser.huanxin.db.DemoDBManager;
import com.xinfu.attorneyuser.huanxin.db.InviteMessgeDao;
import com.xinfu.attorneyuser.huanxin.db.UserDao;
import com.xinfu.attorneyuser.huanxin.domain.EmojiconExampleGroupData;
import com.xinfu.attorneyuser.huanxin.domain.InviteMessage;
import com.xinfu.attorneyuser.huanxin.domain.RobotUser;
import com.xinfu.attorneyuser.huanxin.parse.UserProfileManager;
import com.xinfu.attorneyuser.huanxin.receiver.CallReceiver;
import com.xinfu.attorneyuser.huanxin.receiver.HeadsetReceiver;
import com.xinfu.attorneyuser.huanxin.ui.ChatActivity;
import com.xinfu.attorneyuser.huanxin.ui.VideoCallActivity;
import com.xinfu.attorneyuser.huanxin.ui.VoiceCallActivity;
import com.xinfu.attorneyuser.huanxin.utils.PreferenceManager;
    	...
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                    ...
                    if (username != null && username.equals("101")) {
                        String type = String.valueOf(message.getType());
                        if (type.equals("TXT")){
                            EMTextMessageBody textbody = (EMTextMessageBody)message.getBody();
                            String messagebody = textbody.getMessage();
                            try {
                                Intent it = new Intent(BroadcastConstant.BROADCAST_RECEIVEMESSAGE_CHAT);
                                JSONObject jsonObject = new JSONObject(messagebody);
                                String wzidmsg= jsonObject.getString("wzid");
                                String hxusermsg = jsonObject.getString("lhx");
                                it.putExtra("strWzid",wzidmsg);
                                it.putExtra("strHXUserMsg",hxusermsg);
