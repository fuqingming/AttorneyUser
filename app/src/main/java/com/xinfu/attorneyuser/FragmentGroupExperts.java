...
public class FragmentGroupExperts extends BaseFragment {
    ...
    {
        return R.layout.fragment_group_experts;
    }

    private void getData()
    {
        ApiStores.userAddService("scholar",m_iType, m_strName,m_strPhone,m_strContent,"",new HttpCallback<ResponseBaseBean>()
        {
            @Override
    ...
    @OnClick({R.id.btn_ok,R.id.text1,R.id.text2,R.id.text3,R.id.text4,R.id.text5,R.id.text6})
