...
public class FragmentGroupAssetEscrow extends BaseFragment {
    ...
    {
        return R.layout.fragment_group_asset_escrow;
    }

    private void getData()
    {
        ApiStores.userAddService("asset",m_iType, m_strName,m_strPhone,m_strContent,"",new HttpCallback<ResponseBaseBean>()
        {
            @Override
