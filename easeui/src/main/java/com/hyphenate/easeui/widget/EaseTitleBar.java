...
import com.hyphenate.easeui.utils.NotifyLawyerCounter;
...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected TextView m_tvNotify;
    protected RelativeLayout titleLayout;

    protected NotifyLawyerCounter m_myCount = null;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        m_tvNotify = (TextView) findViewById(R.id.tv_notify);
    ...
    public void setNotifyTime(final Context context, int iSecond,OnTaskSuccessComplete onTaskSuccessComplete){
        m_myCount = new NotifyLawyerCounter(context, m_tvNotify, iSecond * 1000, 1000,onTaskSuccessComplete);
        m_myCount.start();
    }
